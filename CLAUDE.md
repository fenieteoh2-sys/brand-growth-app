...
A personal sales-script generator that captures MQL/SQL leads, drafts AI-powered sales scripts, and tracks conversion — deployable in days as a live portfolio proof.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "238514474+fenieteoh2-sys@users.noreply.github.com"
  git config user.name "fenieteoh2-sys"
  ```
